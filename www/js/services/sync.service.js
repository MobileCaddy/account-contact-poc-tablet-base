...
(function() {
	...
	function SyncService($rootScope, devUtils, LocalNotificationService, UserService) {
		...
		var appTables = [
			{'Name': 'AccountTable__ap', 'syncWithoutLocalUpdates': true, 'maxTableAge' : fourHours},
			{'Name': 'Contact__ap', 'syncWithoutLocalUpdates': true, 'maxTableAge' : fourHours},
			{'Name': 'Poc_Asset__ap', 'syncWithoutLocalUpdates': true, 'maxTableAge' : fourHours}
		];

		var appTablesSyncNow = [
			{'Name': 'AccountTable__ap', 'syncWithoutLocalUpdates': true, 'maxTableAge' : 0},
			{'Name': 'Contact__ap', 'syncWithoutLocalUpdates': true, 'maxTableAge' : 0},
			{'Name': 'Poc_Asset__ap', 'syncWithoutLocalUpdates': true, 'maxTableAge' : 0}
		];
